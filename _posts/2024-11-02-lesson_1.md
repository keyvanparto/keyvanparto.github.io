...
<h2 id="world-phenomena"><span class="me-2">Formalizing World Phenomena</span><a href="#world-phenomena" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h2>
...
<h3 id="noise"><span class="me-2">Noise</span><a href="#noise" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h2 id="data-formalization"><span class="me-2">Formalizing Units</span><a href="#data-formalization" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h2>
...
<h3 id="real-numbers"><span class="me-2">Real Numbers and Vectors</span><a href="#real-numbers" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h3 id="categorical-variables"><span class="me-2">Categories</span><a href="#categorical-variables" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h3 id="graph"><span class="me-2">Graphs</span><a href="#graph" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h2 id="computational-problems"><span class="me-2">Classes of Computational Problems</span><a href="#computational-problems" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h2>

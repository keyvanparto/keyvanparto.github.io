...
<h2 id="data-formalization"><span class="me-2">Formalizzazione delle unità</span><a href="#data-formalization" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h2>
...
<h3 id="real-numbers"><span class="me-2">Numeri reali e vettori</span><a href="#real-numbers" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h3 id="categorical-variables"><span class="me-2">Categorie</span><a href="#categorical-variables" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h3 id="graph"><span class="me-2">Grafi</span><a href="#graph" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h3>
...
<h2 id="computational-problems"><span class="me-2">Classi di problemi computazionali</span><a href="#computational-problems" class="anchor text-muted"><i class="fas fa-hashtag"></i></a></h2>
